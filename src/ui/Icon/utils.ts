...
export function changeColorToClassName(color: Colors): string {
  switch (color) {
    case Colors.EMOCIONAL:
      return 'sendbird-icon-color--emocional';
    case Colors.PRIMARY:
...
export function changeTypeToIconClassName(type: Types): string {
  switch (type) {
    ...
    default:
      return 'sendbird-icon-unknown'; // If you see this text 'icon' replace icon for it
  }
}
