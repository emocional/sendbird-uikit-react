...
// Group Channel - Conversación
    ...
    // Claves nuevas upstream 3.18
    CHANNEL__MESSAGE_LIST__NOTIFICATION__NEW_MESSAGE_S: 'nuevos mensajes',
    CHANNEL__MESSAGE_LIST__NOTIFICATION__UNREAD_MESSAGE: 'mensaje no leído',
    CHANNEL__MESSAGE_LIST__NOTIFICATION__UNREAD_MESSAGE_S: 'mensajes no leídos',
    DATE_FORMAT__LAST_MESSAGE_CREATED_AT__TODAY: 'p',
    DATE_FORMAT__LAST_MESSAGE_CREATED_AT__THIS_YEAR: 'd MMM',
    DATE_FORMAT__LAST_MESSAGE_CREATED_AT__PREVIOUS_YEAR: 'yyyy/M/d',
    DATE_FORMAT__MESSAGE_CREATED_AT: 'p',
    DATE_FORMAT__UNREAD_SINCE: 'p dd MMM',
    FILE_UPLOAD_NOTIFICATION__UNSUPPORTED_FILE_TYPE: 'No se pudo adjuntar el archivo porque el formato no es compatible.',
    FORM_ITEM_INVALID: 'Comprueba el valor',
    FORM_ITEM_OPTIONAL_EMPTY: 'Sin respuesta',
    FORM_ITEM_REQUIRED: 'Este campo es obligatorio',
    FORM_VERSION_ERROR: 'Los mensajes de tipo formulario no están disponibles en esta versión.',
    MESSAGE_INPUT__PENDING_FILE__REMOVE: 'Quitar archivo',
    MESSAGE_INPUT__PENDING_FILE__TYPE_UNKNOWN: 'ARCHIVO',
    MESSAGE_INPUT__PLACE_HOLDER__FILE_ATTACHED: 'Texto deshabilitado mientras hay un archivo adjunto',
    MESSAGE_INPUT__PLACE_HOLDER__FROZEN: 'El chat no está disponible en este canal',
    MESSAGE_INPUT__PLACE_HOLDER__MESSAGE_FORM: 'Completa el formulario del mensaje.',
    MESSAGE_INPUT__PLACE_HOLDER__SUGGESTED_REPLIES: 'Elige una de las opciones de arriba',
    MESSAGE_MENU__MARK_AS_UNREAD: 'Marcar como no leído',
