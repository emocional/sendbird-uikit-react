...
export interface ChannelProviderInterface extends ChannelContextProps, MessageStoreInterface {
  ...
  sendFileMessage: (file: File, quoteMessage?: SendableMessageType, extraParams?: { message?: string }) => Promise<FileMessage>,
  sendVoiceMessage: (file: File, duration: number, quoteMessage?: SendableMessageType) => Promise<FileMessage>,
  sendMultipleFilesMessage: (files: Array<File>, quoteMessage?: SendableMessageType, extraParams?: { message?: string }) => Promise<MultipleFilesMessage>,
